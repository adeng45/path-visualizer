import { getUntraversedNeighbors, isSameTile, removeTileFromQueue, retrievePath } from "../../utils/tileFunctions";
import { initFunctionCost, initHeuristicCost } from "../../utils/miscFunctions";
    ...
    if (currentTile) {
      ...
      for (let i = 0; i < neighbors.length; i += 1) {
        ...
        if (distanceToNeighbor < neighbors[i].distance) {
          ...
          removeTileFromQueue(neighbors[i], untraversedTiles); // Remove the neighbor from the queue
